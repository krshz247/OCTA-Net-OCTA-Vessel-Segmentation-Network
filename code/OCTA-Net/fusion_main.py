...
if isTraining:  # train
    ...
    for epoch in range(args.second_epochs):
        ...
        print('-' * 10)
        second_net = train_second_stage(viz, writer, train_dataloader, first_net_thick, first_net_thin, second_net, second_optim,
                                        args.init_lr, fusion_criterion, device, args.power, epoch + 300, args.second_epochs + 300)
